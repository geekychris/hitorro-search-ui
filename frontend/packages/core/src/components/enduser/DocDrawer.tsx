...
export function DocDrawer({ index, docKey, onClose }: { index: string; docKey: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-40" role="dialog">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-[560px] max-w-full bg-white shadow-2xl overflow-auto">
        ...
        <div className="p-3">
          ...
          {data && (
            <pre className="text-[11px] whitespace-pre-wrap break-words bg-slate-50 p-2 rounded">
