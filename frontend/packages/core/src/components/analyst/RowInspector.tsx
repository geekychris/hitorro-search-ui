...
export function RowInspector({ hit, onClose }: { hit: SearchHit; onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-40" role="dialog">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-[640px] max-w-full bg-white shadow-2xl overflow-auto">
        ...
        <pre className="text-[11px] whitespace-pre-wrap break-words p-3 bg-slate-50">
